const e=`declare module 'three/examples/jsm/nodes/shadernode/ShaderNodeElements' {
import Node from 'three/examples/jsm/nodes/core/Node';
import RangeNode, { RangeModeBound } from 'three/examples/jsm/nodes/geometry/RangeNode';
import { NodeRepresentation, Swizzable } from 'three/examples/jsm/nodes/shadernode/ShaderNode';
import {
    CubeTexture,
    InstancedMesh,
    Light,
...
export * from 'three/examples/jsm/nodes/shadernode/ShaderNodeBaseElements';

// functions

export { default as BRDF_GGX } from 'three/examples/jsm/nodes/functions/BSDF/BRDF_GGX'; // see https://github.com/tc39/proposal-export-default-from
export { default as BRDF_Lambert } from 'three/examples/jsm/nodes/functions/BSDF/BRDF_Lambert';
export { default as D_GGX } from 'three/examples/jsm/nodes/functions/BSDF/D_GGX';
export { default as DFGApprox } from 'three/examples/jsm/nodes/functions/BSDF/DFGApprox';
export { default as F_Schlick } from 'three/examples/jsm/nodes/functions/BSDF/F_Schlick';
export { default as V_GGX_SmithCorrelated } from 'three/examples/jsm/nodes/functions/BSDF/V_GGX_SmithCorrelated';

export { default as getDistanceAttenuation } from 'three/examples/jsm/nodes/functions/light/getDistanceAttenuation';

export { default as getGeometryRoughness } from 'three/examples/jsm/nodes/functions/material/getGeometryRoughness';
export { default as getRoughness } from 'three/examples/jsm/nodes/functions/material/getRoughness';

export { default as PhysicalLightingModel } from 'three/examples/jsm/nodes/functions/PhysicalLightingModel';
