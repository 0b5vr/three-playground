const t=`declare module '@pixiv/three-vrm-node-constraint/VRMNodeConstraintLoaderPlugin' {
import type * as ConstraintSchema from '@pixiv/types-vrmc-node-constraint-1.0';
import type * as THREE from 'three';
import type { GLTF, GLTFLoaderPlugin, GLTFParser } from 'three/examples/jsm/loaders/GLTFLoader.js';
import type { VRMNodeConstraintLoaderPluginOptions } from '@pixiv/three-vrm-node-constraint/VRMNodeConstraintLoaderPluginOptions';
import { VRMNodeConstraintManager } from '@pixiv/three-vrm-node-constraint/VRMNodeConstraintManager';
import { VRMRotationConstraint } from '@pixiv/three-vrm-node-constraint/VRMRotationConstraint';
import { VRMAimConstraint } from '@pixiv/three-vrm-node-constraint/VRMAimConstraint';
import { VRMRollConstraint } from '@pixiv/three-vrm-node-constraint/VRMRollConstraint';
