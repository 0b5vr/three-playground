...
import { THREESubset, Ref, MOUSE_BUTTON, ACTION, PointerInput, MouseButtons, Touches, FitToOptions, CameraControlsEventMap } from 'camera-controls/types';\r
...
\r
    ...
    */\r
    ...
    maxZoom: number;\r
    /**\r
     * Approximate time in seconds to reach the target. A smaller value will reach the target faster.\r
     * @category Properties\r
     */\r
    smoothTime: number;\r
    /**\r
     * the smoothTime while dragging\r
     * @category Properties\r
     */\r
    draggingSmoothTime: number;\r
    /**\r
     * Max transition speed in unit-per-seconds\r
     * @category Properties\r
     */\r
    maxSpeed: number;\r
    /**\r
    ...
    dollySpeed: number;\r
    /**\r
     * \`true\` to invert direction when dollying or zooming via drag\r
     * @category Properties\r
     */\r
    dollyDragInverted: boolean;\r
    /**\r
    ...
    protected _cameraUp0: _THREE.Vector3;\r
    ...
    protected _isUserControllingRotate: boolean;\r
    protected _isUserControllingDolly: boolean;\r
    protected _isUserControllingTruck: boolean;\r
    protected _isUserControllingOffset: boolean;\r
    protected _isUserControllingZoom: boolean;\r
    protected _thetaVelocity: Ref;\r
    protected _phiVelocity: Ref;\r
    protected _radiusVelocity: Ref;\r
    protected _targetVelocity: _THREE.Vector3;\r
    protected _focalOffsetVelocity: _THREE.Vector3;\r
    protected _zoomVelocity: Ref;\r
    /**\r
    ...
    */\r
    ...
    /**\r
     * Move up / down.\r
     * @param height Amount to move up / down. Negative value to move down\r
     * @param enableTransition Whether to move smoothly or immediately\r
     * @category Methods\r
     */\r
    elevate(height: number, enableTransition?: boolean): Promise<void>;\r
    /**\r
    ...
    /**\r
     * Look in the given point direction.\r
     * @param x point x.\r
     * @param y point y.\r
     * @param z point z.\r
     * @param enableTransition Whether to move smoothly or immediately.\r
     ...
     * @category Methods\r
     */\r
    lookInDirectionOf(x: number, y: number, z: number, enableTransition?: boolean): Promise<void>;\r
    /**\r
    ...
    /**\r
     * Look at the \`target\` from the \`position\`.\r
     * @param positionX\r
     * @param positionY\r
     * @param positionZ\r
     * @param targetX\r
    ...
    /**\r
     * Set angle and distance by given position.\r
     * An alias of \`setLookAt()\`, without target change. Thus keep gazing at the current target\r
     * @param positionX\r
     * @param positionY\r
     * @param positionZ\r
     * @param enableTransition\r
    ...
    /**\r
     * Set the target position where gaze at.\r
     * An alias of \`setLookAt()\`, without position change. Thus keep the same position.\r
     * @param targetX\r
     * @param targetY\r
     * @param targetZ\r
     * @param enableTransition\r
    ...
    /**\r
     * Apply current camera-up direction to the camera.\r
     * The orbit system will be re-initialized with the current position.\r
     * @category Methods\r
     */\r
    applyCameraUp(): void;\r
    /**\r
    ...
    /**\r
     * Attach all internal event handlers to enable drag control.\r
     * @category Methods\r
     */\r
    connect(domElement: HTMLElement): void;\r
    /**\r
     * Detach all internal event handlers to disable drag control.\r
     */\r
    disconnect(): void;\r
    /**\r
     ...
     */\r
    dispose(): void;\r
    protected _findPointerById(pointerId: number): PointerInput | undefined;\r
    protected _findPointerByMouseButton(mouseButton: MOUSE_BUTTON): PointerInput | undefined;\r
     ...
     */\r
    protected _getClientRect(target: DOMRect): DOMRect | undefined;\r
    protected _createOnRestPromise(resolveImmediately: boolean): Promise<void>;\r
    protected _addAllEventListeners(_domElement: HTMLElement): void;\r
    protected _removeAllEventListeners(): void;\r
    /*\r
    * backward compatible\r
    * @deprecated use smoothTime (in seconds) instead\r
    * @category Properties\r
    \r
    \r
    * backward compatible\r
    ...
    */\r
    ...
    /*\r
    * backward compatible\r
    * @deprecated use draggingSmoothTime (in seconds) instead\r
    * @category Properties\r
    \r
    \r
    * backward compatible\r
    ...
    */\r
    ...
    static createBoundingSphere(object3d: _THREE.Object3D, out?: _THREE.Sphere): _THREE.Sphere;\r
}\r
